...
use Pishgaman\CyberspaceMonitoring\Controllers\web\PayeshTelegramController;
...
Route::get('/payesh/telegram//group/list', [PayeshTelegramController::class, 'messagesList'])->name('payesh_telegram_messages_list')->middleware(['auth','CheckMenuAccess','web']);
Route::get('/payesh/telegram/channel/list', [PayeshTelegramController::class, 'telegramChannelMessagesList'])->name('payesh_telegram_channel_messages_list')->middleware(['auth','CheckMenuAccess','web']);
Route::get('/payesh/telegram/users/list', [PayeshTelegramController::class, 'userList'])->name('payesh_telegram_user_list')->middleware(['auth','CheckMenuAccess','web']);
