                ...
                <div class="accordion-row">
                    ...
                    <div class="accordion-body">
                        <div class="row gutters form-row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="search_group_id">شناسه کانال:</label>
                                    <input class="form-control text-left" id="search_group_id" v-model="search_group_id" placeholder="شناسه کانال را برای فیلتر کردن وارد کنید" dir="rtl">
                                </div>
                            </div>                 
    ...
    methods: {
        ...
        SystemMonitoringInformation() {   
            axios.get(this.getAppUrl() + 'sanctum/getToken').then(response => {
                ...
                axios.request({
                    method: 'GET',
                    url: this.getAppUrl() + 'api/payesh/information?action=channelHome&search_text='+this.search_text+'&date_start='+this.date_start+'&date_end='+this.date_end+'&search_user_id='+this.search_user_id+'&search_group_id='+this.search_group_id,
        ...
        getTelegramStatistics() {   
            axios.get(this.getAppUrl() + 'sanctum/getToken').then(response => {
                ...
                axios.request({
                    method: 'GET',
                    url: this.getAppUrl() + 'api/payesh/information?action=channeltelegramStatistics&search_text='+this.search_text+'&date_start='+this.date_start+'&date_end='+this.date_end+'&search_user_id='+this.search_user_id+'&search_group_id='+this.search_group_id,
                    headers: {'Authorization': `Bearer ${token}`}
                }).then(response => {
        ...
        getReleaseProcess() {   
            axios.get(this.getAppUrl() + 'sanctum/getToken').then(response => {
                ...
                axios.request({
                    method: 'GET',
                    url: this.getAppUrl() + 'api/payesh/information?action=channelReleaseProcess&search_text='+this.search_text+'&date_start='+this.date_start+'&date_end='+this.date_end+'&search_user_id='+this.search_user_id+'&search_group_id='+this.search_group_id,
                    headers: {'Authorization': `Bearer ${token}`}
                }).then(response => {
