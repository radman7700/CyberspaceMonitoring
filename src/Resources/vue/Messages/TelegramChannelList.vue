    ...
    methods: {
        ...
        getMessageList(page=1,sort='') {   
            axios.get(this.getAppUrl() + 'sanctum/getToken').then(response => {
                ...
                axios.request({
                    method: 'GET',
                    url: this.getAppUrl() + 'api/payesh/telegram?action=getTelegramChannelMessagesList&page='+page+'&search_text='+this.search_text+'&date_start='+this.date_start+'&date_end='+this.date_end+'&search_user_id='+this.search_user_id+'&search_group_id='+this.search_group_id,
